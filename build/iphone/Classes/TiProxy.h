...
//Rare exceptions to indicate a bug in the _flippinghammer code (Eg, function that a subclass should have implemented)
...
/**
 The base class for FlippingHammer proxies.
 */
