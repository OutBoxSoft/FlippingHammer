...
/**
 Base class for all FlippingHammer views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FlippingHammer view hierarchy (such as wrapped iOS UIViews) was touched.
