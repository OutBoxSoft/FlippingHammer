...
// in simulator we redefine to format for FlippingHammer Developer console
...
{\
	NSString * exceptionName = [@"org.flippinghammer." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.flippinghammer";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFlippingHammerNativeItemNone = -1, 
	UIFlippingHammerNativeItemSpinner = -2,
	UIFlippingHammerNativeItemProgressBar = -3,
	
	UIFlippingHammerNativeItemSlider = -4,
	UIFlippingHammerNativeItemSwitch = -5,
	UIFlippingHammerNativeItemMultiButton = -6,
	UIFlippingHammerNativeItemSegmented = -7,
	
	UIFlippingHammerNativeItemTextView = -8,
	UIFlippingHammerNativeItemTextField = -9,
	UIFlippingHammerNativeItemSearchBar = -10,
	
	UIFlippingHammerNativeItemPicker = -11,
	UIFlippingHammerNativeItemDatePicker = -12,
	
	UIFlippingHammerNativeItemInfoLight = -13,
	UIFlippingHammerNativeItemInfoDark = -14,
	
	UIFlippingHammerNativeItemDisclosure = -15,
	
	UIFlippingHammerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FlippingHammer instances of
