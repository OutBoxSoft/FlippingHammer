...
@interface FlippingHammerObject : KrollCoverageObject {
#else
@interface FlippingHammerObject : KrollObject {
#endif
@private
...
extern NSString * FlippingHammer$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FlippingHammerObject *_flippinghammer;
    KrollObject* console;
	BOOL shutdown;
