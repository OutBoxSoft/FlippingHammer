...
//@interface FlippingHammerObject : NSObject
//@end

@interface FlippingHammerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FlippingHammerObject class]])
		{
			for (NSString *key in [[(FlippingHammerObject*)o modules] allKeys])
			{
