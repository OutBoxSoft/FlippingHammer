...
/**
 The base class for all FlippingHammer modules
 */
...
/**
 FlippingHammer Platform calls this method on startup.
 */
-(void)startup;

/**
 FlippingHammer Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 FlippingHammer Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 FlippingHammer Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 FlippingHammer Platform calls this method on resume.
 @param sender The sender of the event.
 */
